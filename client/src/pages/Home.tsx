            ...
            <div className="flex flex-col items-start gap-4 md:items-end">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  >
                    <div className="floater absolute top-0 left-0 h-full w-full rounded-full bg-violet-400 duration-300 group-hover:-top-8 group-hover:shadow-2xl" />
                    <div className="icon relative z-10 flex h-full w-full items-center justify-center rounded-full border-2 border-violet-400">
                      <svg
                        fill="none"
                        viewBox="0 0 22 22"
                        height="22"
                      ...
                      >
                        <path
                          ...
                          className="fill-white duration-300 group-hover:fill-[#171543]"
                        />
                        <path
                ...
                <div>
                  <button
                    ...
                    aria-label="X"
                  >
                    <div className="floater absolute top-0 left-0 h-full w-full rounded-full bg-black duration-300 group-hover:-top-8 group-hover:shadow-2xl" />
                    <div className="icon relative z-10 flex h-full w-full items-center justify-center rounded-full border-2 border-black">
                      <svg
                        fill="none"
                        viewBox="0 0 22 22"
                        height="22"
                ...
                <div>
                  <button
                    ...
                    aria-label="Facebook"
                  >
                    <div className="floater absolute top-0 left-0 h-full w-full rounded-full bg-blue-500 duration-300 group-hover:-top-8 group-hover:shadow-2xl" />
                    <div className="icon relative z-10 flex h-full w-full items-center justify-center rounded-full border-2 border-blue-500">
                      <svg
                        fill="none"
                        viewBox="0 0 13 22"
                        height="22"
                ...
                <div>
                  <button
                    ...
                    aria-label="YouTube"
                  >
                    <div className="floater absolute top-0 left-0 h-full w-full rounded-full bg-red-400 duration-300 group-hover:-top-8 group-hover:shadow-2xl" />
                    <div className="icon relative z-10 flex h-full w-full items-center justify-center rounded-full border-2 border-red-400">
                      <svg
                        fill="none"
                        viewBox="0 0 30 22"
                        height="22"
